// <copyright file="ExchangeTokenResponse.cs" company="CS:GO Tunes">
...
{
    /// <summary>
    /// A response from Spotify's exchange token endpoint.
    ...
    {
        /// <summary>
        /// Gets the access token returned by the exchange.
        /// </summary>
        [JsonProperty("access_token")]
        public string? AccessToken { get; init; }

        /// <summary>
        /// Gets the token type returned by the exchange.
        /// </summary>
        [JsonProperty("token_type")]
        public string? TokenType { get; init; }

        /// <summary>
        /// Gets the scopes granted by the exchange.
        /// </summary>
        [JsonProperty("scope")]
        ...
        /// <summary>
        /// Gets the refresh token returned by the exchange.
        /// </summary>
